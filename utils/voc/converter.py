...
def process_cvat_xml(xml_dir, image_dir, output_dir):
    """
    ...
    for xml in os.listdir(xml_dir):
        ...
        if (tracks is not None) and (len(tracks) > 0):
            ...
            for frameid in sorted(frames.keys()):
                ...
                output_image_path = os.path.join(output_img_dir, os.path.basename(image_name))
                ...
                anno_dir = os.path.dirname(os.path.join(output_xml_dir, image_name))
